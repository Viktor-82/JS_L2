...
/* Здесь записана заготовка готового кода */
// let inputEl = document.querySelectorAll('input');
// // let priceEl = [];
// // let caloriesEl = [];
// let priceEl = null;
...
//     inputEl.forEach((el)=>{
//        if (el.checked) {
//         // priceEl.push(el.dataset.price)
//         // caloriesEl.push(el.dataset.calories)
//         priceEl += Number(el.dataset.price);
//         caloriesEl += Number(el.dataset.calories);
//        }
//     })
//     console.log(priceEl)
//     console.log(caloriesEl)
// })
